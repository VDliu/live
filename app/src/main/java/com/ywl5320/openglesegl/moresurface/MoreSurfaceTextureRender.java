 ...
 * 左手坐标：拇指 x 是指y 中z
 */
public class MoreSurfaceTextureRender implements WLEGLSurfaceView.WlGLRender {
    private static final String TAG = "MoreSurfaceTR";
...
//            1f, 0f
    ...
    public MoreSurfaceTextureRender(Context context) {
    ...
    public void onSurfaceCreated() {
        ...
        if (onRenderTextureListener != null) {
            onRenderTextureListener.onCreate(textureid);
        }
...
//
    ...
    private OnRenderTextureListener onRenderTextureListener;

    public void setOnRenderTextureListener(OnRenderTextureListener onRenderTextureListener) {
        this.onRenderTextureListener = onRenderTextureListener;
    }

    public interface OnRenderTextureListener {
        void onCreate(int texture_id);
    }
